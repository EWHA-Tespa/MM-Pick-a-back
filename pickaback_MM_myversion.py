...
for task_id in range(start_index, num_groups + 1):
    ...
    train_loader = train_loader_fn(args.dataset_config, batch_size) # task의 validset
    val_loader = val_loader_fn(args.dataset_config, val_batch_size)
    train_loader2 = train_loader_fn(args.dataset_config, batch_size) # target의 validset
